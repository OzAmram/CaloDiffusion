...
def make_plots(flags):
    ...
    def IncidentE(data_dict,es):
        ...
        fig,ax0 = utils.HistRoutine(feed_dict,xlabel='Gen. energy', logy=False,binning=binning, ratio = True, plot_label = flags.plot_label)
        for plt_ext in plt_exts: fig.savefig('{}/EInc_{}_{}.{}'.format(flags.plot_folder,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        return feed_dict
    ...
    def HistERatio(data_dict,es):
        ...
        for plt_ext in plt_exts: fig.savefig('{}/ERatio_{}_{}.{}'.format(flags.plot_folder,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        return feed_dict
    ...
    def ScatterESplit(data_dict,es):
        ...
        for plt_ext in plt_exts: fig.savefig('{}/Scatter_{}_{}.{}'.format(flags.plot_folder,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
    ...
    def AverageShowerWidth(data_dict):
        ...
        for plt_ext in plt_exts: fig.savefig('{}/{}EC_{}_{}.{}'.format(flags.plot_folder,f_str1,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        ...
        for plt_ext in plt_exts: fig.savefig('{}/{}EC_{}_{}.{}'.format(flags.plot_folder,f_str2,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        fig,ax0 = utils.PlotRoutine(feed_dict_r2,xlabel='Layer number', ylabel= '%s-width' % xlabel1, plot_label = flags.plot_label)
        for plt_ext in plt_exts: fig.savefig('{}/{}W_{}_{}.{}'.format(flags.plot_folder,f_str1,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        fig,ax0 = utils.PlotRoutine(feed_dict_phi2,xlabel='Layer number', ylabel= '%s-width (radians)' % xlabel2, plot_label = flags.plot_label)
        for plt_ext in plt_exts: fig.savefig('{}/{}W_{}_{}.{}'.format(flags.plot_folder,f_str2,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
    ...
    def ELayer(data_dict):
        ...
        for plt_ext in plt_exts: fig.savefig('{}/NonZeroEnergyZ_{}_{}.{}'.format(flags.plot_folder,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
    ...
    def AverageER(data_dict):
        ...
        for plt_ext in plt_exts: fig.savefig('{}/Energy{}_{}_{}.{}'.format(flags.plot_folder,f_str, dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        return feed_dict
    ...
    def HistEtot(data_dict):
        ...
        ax0.set_xscale("log")
        for plt_ext in plt_exts: fig.savefig('{}/TotalE_{}_{}.{}'.format(flags.plot_folder,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        return feed_dict
    ...
    def HistNhits(data_dict):
        ...
        for plt_ext in plt_exts: fig.savefig('{}/Nhits_{}_{}.{}'.format(flags.plot_folder,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        return feed_dict
    ...
    def HistMaxELayer(data_dict):
        ...
        for plt_ext in plt_exts: fig.savefig('{}/MaxEnergyZ_{}_{}.{}'.format(flags.plot_folder,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        return feed_dict
    ...
    def HistMaxE(data_dict):
        ...
        for plt_ext in plt_exts: fig.savefig('{}/MaxEnergy_{}_{}.{}'.format(flags.plot_folder,dataset_config['CHECKPOINT_NAME'],flags.model, plt_ext))
        return feed_dict
